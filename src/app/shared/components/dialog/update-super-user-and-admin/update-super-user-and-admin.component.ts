...
@Component({
  selector: 'app-update-super-user-and-admin',
  templateUrl: './update-super-user-and-admin.component.html',
  styleUrls: ['./update-super-user-and-admin.component.scss']
})
export class UpdateSuperUserAndAdminComponent implements OnInit {
  ...
  role:any;
  constructor(public dialogref: MatDialogRef<UpdateSuperUserAndAdminComponent>, @Inject(MAT_DIALOG_DATA) public data:any,
